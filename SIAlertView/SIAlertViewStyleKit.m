...
// ------------------------------------
@implementation SIAlertViewStyleKit
...
+ (UIImage*)imageOfCheckmark
{
    ...
    [SIAlertViewStyleKit drawCheckmark];
...
+ (UIImage*)imageOfNotice
{
    ...
    UIGraphicsBeginImageContextWithOptions(CGSizeMake(80, 80), NO, 0);
    [SIAlertViewStyleKit drawNotice];
...
+ (UIImage*)imageOfWarning
{
    ...
    UIGraphicsBeginImageContextWithOptions(CGSizeMake(80, 80), NO, 0);
    [SIAlertViewStyleKit drawWarning];
...
+ (UIImage*)imageOfQuestion
{
    ...
    UIGraphicsBeginImageContextWithOptions(CGSizeMake(80, 80), NO, 0);
    [SIAlertViewStyleKit drawQuestion];
